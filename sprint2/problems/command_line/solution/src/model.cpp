...
MoveInfo::Position GameSession::CalculateNewPosition(const MoveInfo::Position& position, const MoveInfo::Speed& speed, double delta_time) {
...
bool GameSession::IsWithinAnyRegion(const MoveInfo::Position& pos, const std::unordered_map<int, Region>& regions) {
...
MoveInfo::Position GameSession::MaxValueOfRegion(Region reg, MoveInfo::Direction dir, MoveInfo::Position current_pos) {
 ...
 MoveInfo::Position  GameSession::MoveOnMaxDistance(const MoveInfo::Position& current, const MoveInfo::Position& possible, double current_max) {
